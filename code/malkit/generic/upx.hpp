#ifndef _GVN_UPX_HEAD_
#define _GVN_UPX_HEAD_
...
#include <external/upx/src/conf.h>
#include <external/upx/src/file.h>
#include <external/upx/src/packer.h>
#include <external/upx/src/p_elf.h>
...
static void do_exit(void)
{
    ...
    /// The Key To Victory!
    throw (std::logic_error("[UPX] Somebody needed to hit the john!"));
...
int run(string cmd_line)
{
    ...
    vector<string> args;
    Utils::OptParser::splitArgument(cmd_line, args);
