...
class Gvn_Payload_Linux64b : public Gvn_Payload
{
protected:
...
public:
    Gvn_Payload_Linux64b();
    virtual ~Gvn_Payload_Linux64b();

    virtual bool initialize ( const string &_options );
    virtual bool call();
};

Gvn_Payload_Linux64b::Gvn_Payload_Linux64b()
{
    Gvn_Payload();
...
bool Gvn_Payload_Linux64b::initPayload()
{
    int port = 7357;
...
bool Gvn_Payload_Linux64b::initialize ( const string &_options )
{
    options = _options;
...
bool Gvn_Payload_Linux64b::call()
{
