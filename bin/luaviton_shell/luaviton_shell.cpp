...
/// LUA Verbose Mode
#undef GVN_VERBOSE_LUA

/// DEBUG MODE IS DISABLED
#undef GVN_DEBUG

#define lua_c
#include <external/lua5.1/luaconf.h>
...
static const char *progname = "luaviton_shell";
...
extern "C"
{
#include <external/lua5.1/lobject.h>
#include <external/lua5.1/lfunc.h>
#include <external/lua5.1/ldo.h>
#include <external/lua5.1/lstring.h>
#include <external/lua5.1/lopcodes.h>
#include <external/lua5.1/lundump.h>
}
...
void loadLuaviton()
{
    ...
    /// DEPRECATED!
    // printf("Loading Third-Party Modules...\n");
    ...
    printf("Loading GraVitoN Modules...\n");
    ...
    printf("DONE!\n\n");
    printf("+-----------------------------------------------------------------------+\n");
    printf("|                 Welcome to Luaviton Shell                             |\n");
    printf("|        Part of GraVitoN Project: http://thegraviton.org               |\n");
    printf("|              Based on lua5.1 interactive shell                        |\n");
    printf("+-----------------------------------------------------------------------+\n");
}
...
int main (int argc, char **argv) {
    ...
    lua_State *L = GraVitoN::Core::Luaviton::getInstance().getState();
    ...
    report(L, status);
    /// Luaviton is taking care of doing lua_close
    // lua_close(L);
